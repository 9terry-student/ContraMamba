...
from scripts import (
    reason_router_gen4_mamba370m14b_low_displacement_tokenizer_anchor_eligibility
    as m,
)
...
def test_constants_match_frozen_plan() -> None:
    assert m.PLAN_FREEZE_COMMIT == (
        "7bee947899be6c7808217dc68d09f6d2ad2c5978"
    )
    assert m.STRUCTURAL_FREEZE_COMMIT == (
        "37e8176edceb9da9a976df4520904e31e1134ff5"
    )
    assert m.PAIR_FIRST == 5401
    assert m.PAIR_LAST == 5700
