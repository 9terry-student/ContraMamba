...
# CPU-Runtime-Rebound Phase D Native-State Extraction Execution Authority
# Candidate
...
## CPU-runtime-rebound implementation binding

PHASE_D_RUNNER_IMPLEMENTATION_COMMIT =
343f70f99b152d1bbe558327251b9dfeadf501a7

PHASE_D_RUNNER_SHA256 =
53c8659588a7678b07e65248086eeb6ba353434f543ae483f088dd3eb7be5602

PHASE_D_RUNNER_PATH =
scripts/reason_router_gen4_native_mamba_state_extraction.py

CORRECTED_MEASUREMENT_SHA256 =
ce9b11d53b6cc6ee07a0c68509a1ca4fbb641a20be5275f022fc61ddf83120fa
...
59e33d329aa2278c630b2f2f5141090e97f63ca4
...
## Superseded CPU-runtime execution authority
...
SUPERSEDED_FOR_CPU_RUNTIME_REBOUND_IMPLEMENTATION_BYTES

The authority frozen at 60d72527667214a5ba80bb8291661b8396e29143 does not authorize the CPU-runtime-rebound measurement and runner bytes frozen at 343f70f99b152d1bbe558327251b9dfeadf501a7.
...
## CPU-runtime rebind failure provenance

LATEST_FAILED_RUN =
gen4-native-mamba-phase-d-extraction-60d7252-v3

LATEST_FAILED_RUN_COMMAND_SHA256 =
4ca5267531e61221c61e27ddb3bce803e09a72a1d8a37d80575eb5805480ab81

LATEST_FAILED_RUN_RESULT =
BLOCKED_AT_OUTER_EXACT_RUNTIME_BUILD_TAG_GATE_BEFORE_PHASE_D_RUNNER

LATEST_FAILED_RUN_FIRST_FAILURE =
RuntimeError: torch mismatch: 2.10.0+cpu

LATEST_FAILED_RUN_RELEASE_METADATA_GATE =
PASS

LATEST_FAILED_RUN_RELEASE_ASSET_GATE =
PASS

LATEST_FAILED_RUN_PROVISIONING_GATE =
PASS_REPO_CLEAN

LATEST_FAILED_RUN_PROVISIONING_CLEANUP =
PASS

LATEST_FAILED_RUN_PHASE_D_RUNNER_ENTERED =
NO

LATEST_FAILED_RUN_CHECKPOINT_DESERIALIZATION =
NO

LATEST_FAILED_RUN_MODEL_CONSTRUCTION =
NO

LATEST_FAILED_RUN_SCIENTIFIC_FORWARD_COUNT =
0

LATEST_FAILED_RUN_NATIVE_STATE_EXTRACTION =
NO

LATEST_FAILED_RUN_REUSE =
FORBIDDEN_SINGLE_USE_IDENTITY

TRANSPORT_FAILED_RUN_V1 =
gen4-native-mamba-phase-d-extraction-60d7252-v1

TRANSPORT_FAILED_RUN_V1_COMMAND_SHA256 =
5ebfc859eafb21c5eedc2b4bb23130fde21fe98cad32bd17af26bb7aaeb72d12

TRANSPORT_FAILED_RUN_V1_RESULT =
POWERSHELL_PAYLOAD_REGISTERED_AS_BASH_NO_PHASE_D_RUNNER

TRANSPORT_FAILED_RUN_V2 =
gen4-native-mamba-phase-d-extraction-60d7252-v2

TRANSPORT_FAILED_RUN_V2_COMMAND_SHA256 =
2d41855f322da2dcec18cd0baee7ff73740858182e534eed1dabdf0acdcbc412

TRANSPORT_FAILED_RUN_V2_RESULT =
RUN_PROVENANCE_PATH_COLLISION_NO_PHASE_D_RUNNER

TRANSPORT_FAILED_RUN_REUSE =
FORBIDDEN_SINGLE_USE_IDENTITIES

SCIENTIFIC_CONCLUSION_FROM_FAILED_RUNS =
NONE

## Read-only runtime diagnostic supporting exact rebind

RUNTIME_DIAGNOSTIC_HEAD =
60d72527667214a5ba80bb8291661b8396e29143

RUNTIME_DIAGNOSTIC_WORKTREE =
CLEAN

RUNTIME_DIAGNOSTIC_PYTHON =
3.12.13

RUNTIME_DIAGNOSTIC_NUMPY =
2.0.2

RUNTIME_DIAGNOSTIC_TORCH =
2.10.0+cpu

RUNTIME_DIAGNOSTIC_TRANSFORMERS =
5.0.0

RUNTIME_DIAGNOSTIC_TORCH_CUDA_IS_AVAILABLE =
False

RUNTIME_DIAGNOSTIC_TORCH_CUDA_DEVICE_COUNT =
0

RUNTIME_DIAGNOSTIC_MAMBA_SOURCE_SHA256 =
4c972b30f3c2cca977824fcc6891f956cd4387b6383aa7336848fbc5f2db1d83

RUNTIME_DIAGNOSTIC_MAMBA_SOURCE_BYTES =
39500

RUNTIME_DIAGNOSTIC_CACHE_SOURCE_SHA256 =
6c123bbe3d23500462f0b617119a8231aa054b6d5475b295443a45f34466e6bc

RUNTIME_DIAGNOSTIC_CACHE_SOURCE_BYTES =
60432

RUNTIME_DIAGNOSTIC_SOURCE_IDENTITY =
PASS_EXACT_FROZEN_BYTES

TORCH_BUILD_TAG_REBIND =
EXACTLY_2.10.0+cu128_TO_2.10.0+cpu

GENERIC_RUNTIME_COMPATIBILITY_RELAXATION =
NONE
...
## CPU-only invariant under exact cpu build
...
- torch.__version__ is exactly 2.10.0+cpu;
- torch.cuda.is_available() is False;
- torch.cuda.device_count() is 0.

The exact +cpu build binding does not authorize CUDA scientific execution.
