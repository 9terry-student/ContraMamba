...
- Total rows: 1000
- Total introduced unsafe SUPPORT: 0
- Total introduced REFUTE-to-SUPPORT: 0
- Total introduced SUPPORT-to-REFUTE: 0
- All evaluated datasets safe: False
- Any evaluated dataset improved: False

## Per-Dataset Decisions

- `stage43b1_vitaminc_validation_sample1000`: `STAGE43C0_EXTERNAL_FACTVER_INCOMPLETE`

## Recommendation

At least one external dataset evaluation is incomplete; do not make external safety claims yet.
