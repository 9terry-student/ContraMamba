...
readout--behavior merge, while presenting the four causal stages without
requiring their endpoint notation in the figure itself.
Figure~\ref{fig:scale} combines the frozen five-scale causal support
identities with the separately frozen coordinate-free XG2/XG4 geometry
snapshot imported from scientific result commit
\texttt{593199d8e849572fc77b1b0bc7475d3d19468d12}.
The historical kernel mean-square and leading-plane measurements remain
supporting appendix evidence rather than Figure~\ref{fig:scale} panels.
...
completeness analysis. Figure~\ref{fig:overview} summarizes these same
