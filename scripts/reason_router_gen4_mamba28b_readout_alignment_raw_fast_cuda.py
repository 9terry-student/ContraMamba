...
CONFIRMATION_MANIFEST_PATH = Path(
    "reports/reason_router_gen4_mamba28b_confirmation_runs/"
    "g4k-mamba28b-confirmation-xg1-6301-6600-p3-p5-2gpu-50a63a3/"
...
ITEM_SCHEMA = "gen4-mamba28b-fresh-readout-item-v1"
SUMMARY_SCHEMA = "gen4-mamba28b-fresh-readout-raw-summary-v1"
MANIFEST_SCHEMA = "gen4-mamba28b-fresh-readout-raw-manifest-v1"

RESULT_PASS = "PASS_MAMBA28B_FRESH_DELTA_L_READOUT_RAW"
...
def validate_protocol() -> None:
    require(
        geom.HF_REPO == "state-spaces/mamba-2.8b-hf",
        "HF_REPO",
    )
    require(
        geom.HF_REVISION
...
def load_readout_population() -> tuple[
    ...
    require(
        manifest["pair_id_first"] == "xg1_fact_6601"
        and manifest["pair_id_last"] == "xg1_fact_6900",
        "READOUT_PAIR_RANGE",
    )
    require(
...
def worker_run(
    *,
    ...
    try:
        ...
        meta = {
            "schema_version":
                "gen4-mamba28b-fresh-readout-worker-v1",
            "shard_id": shard_id,
            "physical_device":
                physical_device,
            "logical_device": 0,
