...
PLAN_FREEZE_COMMIT = "8614dd5a4ed77cb56cc6a485f4ab379434a284fa"
PLAN_PATH = (
    "reports/"
    "reason_router_gen4_factor2_calibration_static_audit_report.md"
)
PLAN_BLOB = "90ec869dde6cad2131411ef74beef3328c42c4e7"

STRUCTURAL_FREEZE_COMMIT = "8cc7aa450cb6a16f2e5a2564399d3f07dfd9231e"
STRUCTURAL_DIR = Path(
    "data/reason_router_gen4_factor2_small_alpha_xg1_v1"
)
...
RESULT_BLOCKED = (
    "BLOCKED_GEN4_FACTOR2_SMALL_ALPHA_TOKENIZER_ANCHOR_ELIGIBILITY"
)
SCALE_PASS = "PASS_600_OF_600"
SCALE_BLOCKED = "BLOCKED_TOKENIZER_ANCHOR_INELIGIBILITY"

SUMMARY_SCHEMA = (
    "GEN4_MAMBA370M14B_FACTOR2_SMALL_ALPHA_TOKENIZER_ANCHOR_"
...
def validate_structural_inputs(
    ...
    require(
        manifest["result"]
        == "PASS_GEN4_FACTOR2_SMALL_ALPHA_XG1_5701_6000_STRUCTURAL",
        "STRUCTURAL_RESULT",
    )
    require(
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Gen4 factor-2 small-alpha XG1 5701..6000. "
