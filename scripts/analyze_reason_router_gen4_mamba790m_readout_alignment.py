...
RAW_RUN_NAME = (
    "g4k-mamba790m-readout-xg1-7501-7800-"
    "p2-p5-2gpu-6e3f0dc-retry1"
)

RAW_DIR = (
    ROOT
    / "reports/reason_router_gen4_mamba790m_readout_runs"
    / RAW_RUN_NAME
)
...
EXPECTED_RAW_SHA256 = {
    RAW_MANIFEST_FILE:
        "01c99f196eff8ba8f3d2fb5853e4e967d26203e0d4d868e66b6648245bbcc135",
    SUMMARY_FILE:
        "159704b7f791e2d14a95d9e76937c8c93a835977c19093d4aa94bfb1b3908510",
    ITEM_FILE:
        "8138bb9dccee658f2478b8ffad2f8ab8db51fa415c9ae3114b4d6d48e59b2833",
}
...
ANALYSIS_RESULT = (
    "PASS_GEN4_MAMBA790M_READOUT_ALIGNMENT_STATIC_DESCRIPTIVE"
)
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "of frozen Mamba-790M fresh Delta_L "
