...
ANCHOR_SCHEMA = (
    "GEN4_XG2_BASIS_CROSS_FAMILY_HOLDOUT_TOKENIZER_ANCHOR_ELIGIBILITY_V1"
)
SUMMARY_SCHEMA = (
...
def authenticate(root: Path = ROOT) -> dict[str, str]:
    ...
    builder_path = root / FRESH_BUILDER_PATH
    ...
    require(
        ...
        == FRESH_BUILDER_SHA256,
        (
            "FRESH_BUILDER_SHA256_DRIFT:"
            f"{builder_sha256}"
        ),
    )

    observed["fresh_builder_sha256"] = (
        builder_sha256
    )
...
def load_family(
    ...
    require(
        manifest.get(
            "absolute_schedule_indexing_601_900"
        )
        is True,
...
def _base_summary(
    ...
    return {
        ...
        "phase": (
            "XG2_BASIS_CROSS_FAMILY_HOLDOUT_"
