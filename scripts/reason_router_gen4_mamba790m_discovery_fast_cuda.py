...
STRONG_INDICES_SHA256 = (
    "bcfc31585806a83e780679f6d9e17c47d984acf61678cbb7190e472991a9481d"
)
XG2_BASIS_SHA256 = (
    "cb388cef15f2b2f74a74aae915f474e0a027a471c3251479cc29973c2c4fbfa2"
)
XG4_BASIS_SHA256 = (
    "a7efef8ae47b785f3afb0db8367104bf5eb3480b81ffc4e6391d924c802d9fc6"
)
PLANE_FILE_SHA256 = {
    "P1": {
        "plus": "7f1352554f921d1b9dd0629c4aef67a198d7b70285ccea492cccc67507bde588",
        "minus": "49a12fd7003199313329eb65a38535949720c3e25888e75d249c4e0fb5ca9b01",
    },
    "P2": {
        "plus": "a7cb30f761fef255140834e7aae1c2d1edaae7312f940186943c428b03cc6fd2",
        "minus": "203d6d83c848e7defe1a7a41253035444b0044d06e1fe3301af4cfa5c3775cfe",
    },
    "P3": {
        "plus": "0d63a028bd95596d19ea7def42ce820844a2ba5027c0e7b2ffb71a6c18321a02",
        "minus": "0b4bf57378cd0008f0cefd08065434f04d43b8774d7e031f241093e359ce7c9e",
    },
    "P4": {
        "plus": "a6e5463e1d24d820acbffd48f559261d4257d64bf753f64a40dd7382e7647337",
        "minus": "29dd7d758ca9fd5ae30a03e26967ccef185c643e3cd54195fa1b6f41dc2727f7",
    },
    "P5": {
        "plus": "f88322f93a17e782b7352a1e054ba7c6e1edae347229a74bb0bda2abf0929ead",
        "minus": "2d2dc2f9d99ca81e9fa6492bca8fa9d5afffa1529965d929c9b752cc8e85de7f",
    },
}

DISCOVERY_ROOT = Path(
    "data/reason_router_gen4_mamba790m_xg1_discovery_v1"
)
...
SHARDS = (
    {
        ...
        "start_index": 0,
        "end_index": 150,
        "pair_first": "xg1_fact_6901",
        "pair_last": "xg1_fact_7050",
        "pair_count": 150,
    ...
    },
    {
        ...
        "start_index": 150,
        "end_index": 300,
        "pair_first": "xg1_fact_7051",
        "pair_last": "xg1_fact_7200",
        "pair_count": 150,
        "forward_budget": FORWARDS_PER_SHARD,
    },
)
...
RESULT_PASS = "PASS_MAMBA790M_DISCOVERY_SELECTION_FREEZE"
ITEM_SCHEMA = "gen4-mamba790m-discovery-item-v1"
SELECTION_SCHEMA = "gen4-mamba790m-discovery-selection-v1"
MANIFEST_SCHEMA = "gen4-mamba790m-discovery-manifest-v1"
...
def load_frozen_geometry() -> dict[str, Any]:
    ...
    require(
        summary["result"] == "PASS_MAMBA790M_GEOMETRY_PREPARATION",
        "GEOMETRY_RESULT",
    )
    require(
...
def worker_run(
    *,
    ...
    try:
        ...
        meta = {
            "schema_version": "gen4-mamba790m-discovery-worker-v1",
            "shard_id": shard_id,
...
def run_discovery(
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix="gen4_mamba790m_discovery_"
    ) as tmp:
        temp_dir = Path(tmp)
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Mamba-790M prospective discovery on XG1 6901..7200. "
            "Selects exactly one dominant candidate from response; "
            "confirmation 7201..7500 is not accessed."
        )
    )
...
def main(
    ...
    print("DISCOVERY_RANGE=xg1_fact_6901..xg1_fact_7200")
