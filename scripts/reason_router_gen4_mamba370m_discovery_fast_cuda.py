...
GEOMETRY_SUMMARY_SHA256 = (
    "112d03aa23e105cebcd7893a7c9f8e9d21a135a832a9da7d4caa236fe3c36378"
)
STRONG_INDICES_SHA256 = (
    "b10fc1eae07e184a5ed7975a9296133945d6446ff7f568a18acdf2091a338712"
)
XG2_BASIS_SHA256 = (
    "3cd8287a3d6986c071a6cd8ddb59ba9d36ca8ca02a0e2a42ec0ec04eea70391d"
)
XG4_BASIS_SHA256 = (
    "46a2c5dac0d58d6f1c7811650af59c7a30a9f6cfe546d1468e78677f1fca703f"
)
PLANE_FILE_SHA256 = {
    "P1": {
        "plus": "20624cda88e2c94bb736331e00aa3023d900afd331aec3700ee6d712f59ff77f",
        "minus": "f6b2ca4ebfdd4db306cbcfa8cf93cf725679482c8b3b4c87c81b9cce45c3a833",
    },
    "P2": {
        "plus": "37c7536e0bb9dd01f85f549679b27736b7d75845569ca10e19f832bff8403120",
        "minus": "e127053936fb609a59c7c12663799efe1ed254ce8df5bc5660b2584528f1d26c",
    },
    "P3": {
        "plus": "5d404f8f402639ab101413a0237fa458246a155855507600256fa3dd250adb7f",
        "minus": "4a48563f5e419916a32f4b3a4106bea1056abafd898ef12496ea5bd079bbd0fb",
    },
    "P4": {
        "plus": "d73f63b52d7c198717cd6828c1e41a952803008e5b528880d1f17b61ccea4510",
        "minus": "d9ff5b1dc9fc2977f7b776564411960967b386c522664562efd51884d99b85a4",
    },
    "P5": {
        "plus": "1be1bb5eaee1cdf583c0c4a249ac6dd624e1dd0194bd81c08d34e50cce7a8ed3",
        "minus": "7af4a78366e9258d2833bced5a5c824990d7c062a970d3c44b3adc386db3a0dc",
    },
}
...
SHARDS = (
    {
        ...
        "start_index": 0,
        "end_index": 150,
        "pair_first": "xg1_fact_3001",
        "pair_last": "xg1_fact_3150",
        "pair_count": 150,
    ...
    },
    {
        ...
        "start_index": 150,
        "end_index": 300,
        "pair_first": "xg1_fact_3151",
        "pair_last": "xg1_fact_3300",
        "pair_count": 150,
        "forward_budget": FORWARDS_PER_SHARD,
    },
)
...
RESULT_PASS = "PASS_MAMBA370M_DISCOVERY_SELECTION_FREEZE"
ITEM_SCHEMA = "gen4-mamba370m-discovery-item-v1"
SELECTION_SCHEMA = "gen4-mamba370m-discovery-selection-v1"
MANIFEST_SCHEMA = "gen4-mamba370m-discovery-manifest-v1"
...
def authenticate_repo(expected_head: str) -> None:
    ...
    require(rc == 0, "GEOMETRY_FREEZE_NOT_ANCESTOR")
...
def load_discovery_population() -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    ...
    require(
        manifest["prospective_use"] == "plane_selection_only",
        "DISCOVERY_USE",
    )
    require(
        manifest["selection_response_access_allowed"] is True,
        "DISCOVERY_RESPONSE_AUTH",
    )
    require(
        manifest[
...
def load_frozen_geometry() -> dict[str, Any]:
    ...
    require(
        summary["result"] == "PASS_MAMBA370M_GEOMETRY_PREPARATION",
        "GEOMETRY_RESULT",
    )
    require(
...
def worker_run(
    *,
    ...
    try:
        ...
        meta = {
            "schema_version": "gen4-mamba370m-discovery-worker-v1",
            "shard_id": shard_id,
...
def run_discovery(
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix="gen4_mamba370m_discovery_"
    ) as tmp:
        temp_dir = Path(tmp)
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Mamba-370M prospective discovery on XG1 3001..3300. "
            "Selects exactly one dominant candidate from response; "
            "confirmation 3301..3600 is not accessed."
        )
    )
...
def main(
    ...
    print("DISCOVERY_RANGE=xg1_fact_3001..xg1_fact_3300")
