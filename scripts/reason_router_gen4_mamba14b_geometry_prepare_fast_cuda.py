...
HF_FILES: dict[str, tuple[int, str]] = {
    "config.json": (
        879,
        "275174e4771bb65f70cb1ea03389c9711510438d7944885e8f02f525bec03a9d",
    ),
    ...
    "model-00001-of-00002.safetensors": (
        4960287720,
        "3a0351b2c6a044c5f19f0f8992362e57c0d6f71b0e0702d46f43f3d8a7120c84",
    ),
    "model-00002-of-00002.safetensors": (
        528479144,
        "6cd1ac80d0acd00e6b6afebad9690115c5d932009ba644a6c8af1e0aed8414de",
    ),
    "model.safetensors.index.json": (
        38175,
        "a4739638258ef26762ff808249c3888fdb8bd4a15404a0db4811feb5cf2444b5",
    ),
    "tokenizer.json": (
        2113738,
...
COMPACT_CHECKPOINT_REL = Path(
    "reports/reason_router_gen4_mamba14b_training_runs/"
    "g4k-mamba14b-train-g3d-seed181-dualt4-cache-ae6ab9a/"
...
RESULT_PASS = "PASS_MAMBA14B_GEOMETRY_PREPARATION"
...
def reconstruct_model(
    *,
    ...
    require(
        ...
        == "contramamba_mamba14b_compact_checkpoint_v1",
        "COMPACT_SCHEMA",
    )
...
def run_family(
    *,
    ...
    for pair in pairs:
        ...
        items.append({
            "schema_version": "gen4-mamba14b-geometry-family-item-v1",
            "family_key": family,
            "source_pair_id": pair,
...
def worker_run(
    *,
    ...
    try:
        ...
        meta = {
            "schema_version": "gen4-mamba14b-geometry-worker-v1",
            "gpu_id": gpu_id,
            "family_key": family,
...
def write_output_bundle(
    *,
    ...
    strong_indices = {
        "schema_version": "gen4-mamba14b-strong-mask-v1",
    ...
    summary = {
        "schema_version": "gen4-mamba14b-geometry-preparation-summary-v1",
        "result": RESULT_PASS,
    ...
    manifest = {
        "schema_version": "gen4-mamba14b-geometry-preparation-manifest-v1",
        "result": RESULT_PASS,
        "execution_head": expected_head,
...
def run_geometry_preparation(
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix="gen4_mamba14b_geometry_"
    ) as tmp:
        temp_dir = Path(tmp)
        ...
        for gpu_id, family in enumerate(FAMILIES):
            process = ctx.Process(
                ...
                name=f"mamba14b-geometry-{family}-gpu{gpu_id}",
            )
            process.start()
...
def parse_args(
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Independent Mamba-1.4B XG2/XG4 geometry reconstruction. "
