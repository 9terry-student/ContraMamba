...
MODEL_REPO = "state-spaces/mamba-790m-hf"
MODEL_REVISION = "9822dd4b76af2bd9099b6ce2f19efd8329189a7e"
...
SNAPSHOT_FILES = {
    "config.json": {
        "bytes": 878,
        "sha256": "f55bce4f993e4eeba025d57977eb48c4815416a352742c74e412e2c1e8136ea1",
    },
    ...
    "model.safetensors": {
        "bytes": 3172869936,
        "sha256": "3fbcf74674d28034e728b911315e4749cc4fc34ebfab36099f46d92bb657a617",
    },
    "tokenizer.json": {
        "bytes": 2113738,
...
def compact_selected_checkpoint(
    *,
    ...
    compact_payload = {
        "schema_version": "contramamba_mamba790m_compact_checkpoint_v1",
    ...
    manifest = {
        "schema_version": "contramamba_mamba790m_compact_checkpoint_manifest_v1",
...
def main() -> None:
    ...
    run_dir = ROOT / "reports" / "reason_router_gen4_mamba790m_training_runs" / args.run_name
    ...
    launcher_manifest = {
        "schema_version": "contramamba_mamba790m_training_launcher_v1",
    ...
    print("RESULT=PASS_MAMBA790M_TRAINING_AND_COMPACTION")
