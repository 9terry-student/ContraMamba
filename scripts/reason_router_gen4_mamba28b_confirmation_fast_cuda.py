...
DISCOVERY_FREEZE_COMMIT = "e13154ec99fe232d1e354654937a5823c438ae0d"

DISCOVERY_SELECTION_PATH = Path(
    "reports/reason_router_gen4_mamba28b_discovery_runs/"
    "g4k-mamba28b-discovery-xg1-6001-6300-2gpu-ceb43c7/"
...
CONFIRMATION_ROOT = Path(
    "data/reason_router_gen4_mamba28b_xg1_confirmation_v1"
)
...
SHARDS = (
    {
        ...
        "start_index": 0,
        "end_index": 150,
        "pair_first": "xg1_fact_6301",
        "pair_last": "xg1_fact_6450",
        "pair_count": 150,
    ...
    },
    {
        ...
        "start_index": 150,
        "end_index": 300,
        "pair_first": "xg1_fact_6451",
        "pair_last": "xg1_fact_6600",
        "pair_count": 150,
        "forward_budget": FORWARDS_PER_SHARD,
    },
)
...
ALPHA = 0.05
SUCCESS_LABEL = "MAMBA28B_CORE_CONFIRMATION_SUPPORTED"
FAILURE_LABEL = "MAMBA28B_CORE_CONFIRMATION_NOT_SUPPORTED"
...
RESULT_PASS = "PASS_MAMBA28B_CORE_CONFIRMATION"
ITEM_SCHEMA = "gen4-mamba28b-core-confirmation-item-v1"
INFERENCE_SCHEMA = "gen4-mamba28b-core-confirmation-inference-v1"
MANIFEST_SCHEMA = "gen4-mamba28b-core-confirmation-manifest-v1"
...
def load_frozen_selection() -> dict[str, Any]:
    ...
    require(selection["result"] == "PASS_MAMBA28B_DISCOVERY_SELECTION_FREEZE", "DISCOVERY_SELECTION_RESULT")
...
def infer_confirmation(items: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "result": RESULT_PASS,
        "primary_test": {
            "endpoint": "D_CORE=Q_restored(P3)-Q_control(P5)",
            "null": "E[D_CORE] <= 0",
...
def worker_run(
    *,
    ...
    try:
        ...
        meta = {
            "schema_version": "gen4-mamba28b-core-confirmation-worker-v1",
            "shard_id": shard_id,
...
def run_confirmation(
    *,
    ...
    with tempfile.TemporaryDirectory(
        prefix="gen4_mamba28b_core_confirmation_"
    ) as tmp:
        temp_dir = Path(tmp)
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=("Mamba-2.8B prospective core confirmation on XG1 6301..6600. Uses frozen discovery P3/P5 selection and executes exactly one one-sided one-sample Student t-test on D_CORE."))
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    print("CONFIRMATION_RANGE=xg1_fact_6301..xg1_fact_6600")
