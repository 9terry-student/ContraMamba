...
BACKEND_DISPATCH_VALIDATOR_CORRECTION_AUTHORITY = "94c23155b8422d23ae01c43c0b63c5f696bd52d1"
CPU_TORCH_BUILD_TAG_REBIND_AUTHORITY = "59e33d329aa2278c630b2f2f5141090e97f63ca4"
CACHE_RECURRENT_VALIDATOR_CORRECTION_AUTHORITY = "c4e143e9593503bc9520c864e2a9afa32e266e29"
...
EXECUTION_AUTHORITY_PATH = Path(
    ...
    "phase_d_extraction_execution_authority_cache_recurrent_validator_correction_spec_candidate.md"
)
...
MEASUREMENT_SHA256 = "7729424f03058b86b4f120dc0e6da573d6c996b0877858f2d6d38aa94dac268c"
    ...
    *,
    ...
    try:
        ...
        manifest = {
            ...
            "backend_dispatch_validator_correction_authority": BACKEND_DISPATCH_VALIDATOR_CORRECTION_AUTHORITY,
            "cpu_torch_build_tag_rebind_authority": CPU_TORCH_BUILD_TAG_REBIND_AUTHORITY,
            "cache_recurrent_validator_correction_authority": CACHE_RECURRENT_VALIDATOR_CORRECTION_AUTHORITY,
